...
import {ALL_CLIENTS, CREATE_CLIENT } from '../../mutations/clientMutations'
...
const AddClient = () => {
    ...
    const {first_name, last_name, email, phone01, phone02, city, address} = formFields

    const [createClient] = useMutation(CREATE_CLIENT, {variables : {content : {
        person : {
            first_name,
            last_name,
            email,
  ...
  return (
    <div className={container}>
        ...
        <form className={form}>
            ...
            <button type="button" onClick={saveClient} className={btn}>اضافة</button>
